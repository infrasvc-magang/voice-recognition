document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayMessage(message, sender) {
      ...
      messageBox.rows = Math.ceil(message.length / 100); // Anggap satu baris bisa menampung maksimal 40 karakter
      messageBox.cols = Math.min(message.length, 100); // Jika pesan lebih pendek dari 40 karakter, maka kolom disesuaikan
    ...
    typeMessage('Selamat datang di voice command Experience Center!, Apa yang bisa saya bantu?', 'bot');
